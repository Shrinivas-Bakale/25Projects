            ...
            >
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-black  border-gray-700">
                <li>
                  <a
                    href="#"
                    className="py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent  md:p-0 md:text-blue-500 flex "
                    aria-current="page"
                  >
                ...
                <li>
                  <a
                    href="#"
                    className="py-2 px-3 rounded md:p-0 text-white hover:bg-gray-700 hover:text-white flex"
                  >
                    <RiDiscountPercentFill className="text-white " size={30} />
                    Schemes
                  </a>
                </li>
                <li>
